 ...
 */
final class Version20260315204924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tenant ADD password VARCHAR(255) DEFAULT NULL, ADD roles JSON NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_4E59C462E7927C74 ON tenant');
        $this->addSql('ALTER TABLE tenant DROP password, DROP roles');
    }
}
